...
interface Config {
   ...
   /** Derived byte ceiling for a native/binary artifact body, from FHIR_MAX_ARTIFACT_MB (default 16 MiB). Independent of fhirMaxResponseBytes. */
   fhirMaxArtifactBytes: number
